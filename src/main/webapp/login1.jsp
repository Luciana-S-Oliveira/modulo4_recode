...
<meta name="viewport" content="width=device-width, initial-scale=1.0">
   ...
   <!-- ICON ROTA DE FERIAS -->
    <link rel="shortcut icon" href="img/icon_rotadeferias.svg" type="image/x-icon">
    ...
    <title> Login - Rota de Férias | Agencia de Viagens </title>
    ...
    <div class="container-fluid mt-3">
        ...
        <header class="row">
            ...
            <div class="col-sm-6 mb-2 text-justify">
                <a href="index.html">
                    <img src="img/rotadeferias2.png" alt="Logo" height="60px">
                </a>
            </div>

            <div class="col-sm-6 text-center">

                <p> Descubra o mundo com a Rota de Férias e crie memórias inesquecíveis! </p>
                                ...
                                <div class="modal-body bg-modal">
                                    ...
                                    <form action="CadastrarUsuario" method="post" autocomplete="off">
                                        ...
                                        <input type="tel" class="form-control" name="cpf" id="cliente_cadastrar"
                                            aria-describedby="helpId" placeholder="Digite seu CPF (APENAS N�MEROS)"
                                            maxlength="11" required>


                                        <label class="mt-2" for="senha"> <strong> Digite seu e-mail (Ser� utilizado para o Login): </strong> </label>
    ...
    <footer class="container-fluid bg-light">
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-6 mb-2 text-right">
                <a href="index.html">
                    <img src="img/rotadeferias2.png" alt="logo" width="150px">
                </a>
            </div>

            <div class="col-sm-6 text-justify">

                <h5> Rota de Férias Agencia de viagem </h5>
                <p class="m-0 small">CNPJ 12.123.456/0001-12</p>
                <p class="m-0 small">Rua aaaa, 000 - Marília - SP</p>
                <p class="m-0 small">CEP: 12345-678, Marília/SP</p>
        ...
        <div class="row mt-4 mb-2">
            ...
            <div class="col-lg-2 col-sm-4 small"> <a class="link_rodape" href="termoscondicoes.html"> Termos e condi��es
                </a> </div>
            <div class="col-lg-2 col-sm-4 small"> <a class="link_rodape" href="duvidas.html"> D�vidas </a> </div>
        ...
        <div class="row mt-4 mb-3">
            <div class="col-12 text-center"> &copy 2023 - Rota de Férias Ag�ncia de Viagens </div>
        </div>
